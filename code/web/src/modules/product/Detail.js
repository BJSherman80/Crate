...
class Detail extends PureComponent {
  ...
  //NTS: More ternaries... review logic for rendering of product details, conditionals (error and loading). Issue is in Related.js. Works if comment out line 113 in this file (renders Related)
                ...
                >
                  ...
                  <GridCell style={{ textAlign: "center" }}>
                    ...
                    <p style={{ marginTop: "0.5em", color: grey2 }}>
                      Launched on{" "}
                      {new Date(parseInt(item.createdAt)).toDateString()}
                    </p>
                  </GridCell>
                </Grid>
