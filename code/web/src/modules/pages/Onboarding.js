...
class Onboarding extends PureComponent {
  ...
  render() {
    const steps = [
      ...
      <Grid
        alignCenter={true}
        style={{ height: "100%", textAlign: "center", color: white }}
      >
        ...
        <GridCell>
          ...
          <H6 style={{ marginTop: "0.5em" }}>
            Your monthly subscription of trendy <br /> clothes and accessories
          </H6>
        ...
        <GridCell>
          <img
            src={`${APP_URL}/images/collage.png`}
            alt="collage"
            title="products collage"
            style={{ width: 400 }}
          />
        </GridCell>
      </Grid>,
